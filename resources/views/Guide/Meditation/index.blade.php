  ...
  <div class="pull-right">
    <form action="" method="" class="form-inline pull-right" id="searchForm">
      <div class="form-row">
          ...
          <div class="form-group p-1">
              <a href="{{ url('meditations/create') }}" class="btn btn-primary btn-icon-split">
                  <span class="icon text-white-50">
                      <i class="fa fa-plus-circle"></i>
                  </span>
                  <span class="text">Add Meditation</span>
              </a>
          </div>
      </div>
    </form>
      ...
      <table class="table table-bordered table" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a title="Edit" href="{{ url('meditations/edit/'.$md->id)}}">
                        <i class="fa fa-edit"></i>
                    </a>&nbsp;
                    <a title="View" href="{{ url('meditations/show/'.$md->id)}}">
                        <i class="fa fa-eye"></i>
                    </a>&nbsp;
                    <a title="Delete record" href="{{ url('meditations/delete/'.$md->id)}}" onclick="return confirm('Are you sure? you want to delete this record!')">
