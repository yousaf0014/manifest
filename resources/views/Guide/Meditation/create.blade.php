...
<div class="row small-spacing">
    <div class="col-lg-12 col-xs-12">
        <div class="box-content">
            <div class="pull-left">
                <h2 class="box-title">Add Meditation</h2>
            </div>
            ...
            <div style="padding-top: 30px;">
                <div class="col-lg-12 col-xs-12">
                    <div class="box-content card white">                        
                        ...
                        <form class="form-horizontal" method="post" action="{{url('/meditations/store')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input accept="audio/*" type="file" id="audio" class="form-control @error('audio') is-invalid @enderror" name="audio" value="{{ old('audio') }}" required autocomplete="audio" placeholder="{{ __('audio') }}" >
                                    @error('audio')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
