...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
      <form  method="post" action="{{url('/adminupdateprofile')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
          ...
          <div class="col-sm-6 col-sm-offset-1">
             <div class="picture-container">
                  <div class="picture">
                      <img src="{{Storage::disk('public')->url('uploads/'.$user->pic)}}" class="picture-src" width="200px" id="wizardPicturePreview" title=""/>
