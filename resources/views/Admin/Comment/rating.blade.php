      ...
      <table class="table table-bordered table" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $rate->pivot->rate; ?></td>
                <td><?php echo $rate->first_name.' '.$rate->last_name; ?></td>
                <td>
                    <a title="Delete record" href="{{ url('comments/delete/'.$meditation->id.'/'.$rate->id)}}" onclick="return confirm('Are you sure? you want to delete this record!')">
